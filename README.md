...
![alt text](https://git.oxfordnanolabs.local/bsipos/ont-assembly-polish/raw/master/results/ddif_plots.png "dnadiff accuracies"){:width="600px"}

![alt text](https://git.oxfordnanolabs.local/bsipos/ont-assembly-polish/raw/master/results/la_plots.png "lastal accuracies"){:width="600px"}
